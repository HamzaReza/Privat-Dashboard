...
const benefits = [
  {
    ...
    desc: "Stand out as a trusted professional. Every provider is manually reviewed and approved.",
  },
  {
    icon: Smartphone,
    title: "Manage via App",
    desc: "Use the PRIVAT app on iOS or Android to receive leads, respond to requests, and grow your business.",
  },
  {
    icon: Target,
    title: "High-Intent Leads",
    desc: "Every request is from someone ready to hire. No tyre-kickers or low-quality inquiries.",
  },
  {
    icon: TrendingUp,
    title: "Grow on Your Terms",
    desc: "Target specific categories, areas, and budgets. Scale your pipeline at your pace.",
  },
];
  ...
  return (
    <>
      ...
      <section className="bg-subtle-texture py-24 lg:py-32">
        <div className="container mx-auto px-4 text-center lg:px-8">
          ...
          <p className="mx-auto mt-5 max-w-lg text-base text-[hsl(var(--muted-foreground-hsl))] lg:text-lg">
            Join a verified marketplace of high-intent clients. No monthly fees
      ...
      <SectionWrapper>
        ...
        <div className="mx-auto grid max-w-4xl gap-8 md:grid-cols-2">
          {benefits.map((b) => (
            <div
              key={b.title}
              className="rounded-sm border border-[hsl(var(--border-hsl))/0.5] bg-[hsl(var(--card-hsl))] p-8 transition-all hover:border-[hsl(var(--primary-hsl))/0.3]"
            >
              <b.icon
                size={28}
      ...
      <SectionWrapper>
        <SectionHeading
          title="How It Works"
          subtitle="Simple, transparent, and fair."
        />
        <ol className="mx-auto max-w-lg space-y-4">
          {howItWorks.map((step, i) => (
            <li
              key={i}
              className="flex items-start gap-4 text-sm text-[hsl(var(--muted-foreground-hsl))]"
            >
      ...
      <SectionWrapper className="bg-[hsl(var(--muted-hsl))/0.3]">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mx-auto mt-5 max-w-xl text-base leading-relaxed text-[hsl(var(--muted-foreground-hsl))]">
            Every provider application is reviewed by our team. We verify
            credentials, check references, and ensure only professionals who
            meet our standards are listed. This protects your reputation and the
            clients you serve.
          </p>
        </div>
      </SectionWrapper>
